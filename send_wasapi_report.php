<?php
/**
 * Manual Wasapi Executive Report Sender
 *
 * Modes:
...
if (function_exists('userHasPermission')) {
    try {
        $hasAccess = userHasPermission('settings') || userHasPermission('wasapi_reports');
    } catch (Throwable $e) {
        $hasAccess = false;
    }
}
...
try {
    ...
    try {
        ...
        if (function_exists('log_custom_action')) {
            log_custom_action(
                ...
                'reports',
                'send',
                'Reporte ejecutivo Wasapi enviado manualmente',
                'wasapi_report',
                null,
                [
                    'mode'             => $mode,
        ...
        error_log('send_wasapi_report log error: ' . $e->getMessage());
    }
    ...
    error_log('send_wasapi_report error: ' . $e->getMessage());
