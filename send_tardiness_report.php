<?php
/**
 * Manual Tardiness Report Sender
 *
 * Modes:
...
// Permission gate (same pattern as other automations)
$hasAccess = false;
...
try {
    ...
    try {
        ...
        if (function_exists('log_custom_action')) {
            log_custom_action(
                ...
                'reports',
                'send',
                'Reporte diario de tardanzas enviado manualmente',
                'tardiness_report',
                null,
                [
                    'mode'             => $mode,
        ...
        error_log('send_tardiness_report log error: ' . $e->getMessage());
    }
    ...
    error_log('send_tardiness_report error: ' . $e->getMessage());
