<?php
/**
 * Manual Workforce Report Sender
 *
 * Modes:
...
try {
    ...
    try {
        ...
        if (function_exists('log_custom_action')) {
            log_custom_action(
                ...
                'reports',
                'send',
                'Reporte diario de fuerza laboral enviado manualmente',
                'workforce_report',
                null,
                [
                    'mode'             => $mode,
        ...
        error_log('send_workforce_report log error: ' . $e->getMessage());
    }
    ...
    error_log('send_workforce_report error: ' . $e->getMessage());
