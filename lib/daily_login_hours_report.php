...
<style>
  ...
  .header { background: linear-gradient(135deg, #264b8b 0%, #3a5da0 100%); color: #fff; padding: 28px; text-align: center; border-radius: 10px; }
  ...
  thead { background: linear-gradient(135deg, #264b8b 0%, #3a5da0 100%); }
