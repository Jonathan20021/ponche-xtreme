...
<style>
  ...
  .header { background: linear-gradient(135deg, #6f8bbd 0%, #1f3f76 100%); color: #fff; padding: 28px; text-align: center; border-radius: 10px; }
  ...
  .stat-card.primary  { border-top: 4px solid #6f8bbd; }
  ...
  .section h2 { margin: 0 0 14px 0; font-size: 18px; border-bottom: 2px solid #6f8bbd; padding-bottom: 8px; }
  table { width: 100%; border-collapse: collapse; font-size: 13px; }
  thead { background: linear-gradient(135deg, #6f8bbd 0%, #1f3f76 100%); }
