<?php
/**
 * API para obtener detalles completos de un empleado administrativo específico
 * Incluye historial de punches del día y estadísticas
 * Versión para manager_dashboard
 */
...
try {
    ...
    foreach ($attendanceTypes as $type) {
        ...
        $typesMap[$slug] = [
            ...
            'color_start' => $type['color_start'] ?? '#3a5da0',
            'color_end' => $type['color_end'] ?? '#152849',
